...
import (
	...
	cmtevents "github.com/akshiiitt/CometBFT-Quantum-Dilithium2-/libs/events"
	"github.com/akshiiitt/CometBFT-Quantum-Dilithium2-/libs/fail"
...
func (cs *State) needProofBlock(height int64) bool {
	...
	if lastBlockMeta == nil {
		// See https://github.com/akshiiitt/CometBFT-Quantum-Dilithium2-/issues/370
...
func (cs *State) voteTime() time.Time {
	...
	// even if cs.LockedBlock != nil. See https://github.com/akshiiitt/CometBFT-Quantum-Dilithium2-/tree/v0.38.x/spec/.
	if cs.LockedBlock != nil {
		// See the BFT time spec
		// https://github.com/akshiiitt/CometBFT-Quantum-Dilithium2-/blob/v0.38.x/spec/consensus/bft-time.md
