...
https://github.com/akshiiitt/CometBFT-Quantum-Dilithium2-/blob/v0.38.x/spec/light-client/verification/README.md
for details.
...
for usage example.
Or see
https://github.com/akshiiitt/CometBFT-Quantum-Dilithium2-/tree/v0.38.x/spec/consensus/light-client
for the full spec
*/
package light
